export const translations = {
  en: {
    ...
    whyChooseUs: {
      eyebrow: "Why UpMarket",
      headline1: "Your brand should feel",
      headline2: "credible",
      ...
      reasons: [
        ...
        },
        {
          ...
          description:
            "Clear timelines and smooth execution — without sacrificing quality.",
        },
        {
          title: "Best-practice foundations",
          description:
            "Performance, accessibility, SEO-ready structure, and maintainable code.",
        },
        {
          title: "Support after launch",
          description:
            "Updates, fixes, and improvements available when you need them.",
        },
        {
  ...
  // Simple fallback languages (use English content so TS never breaks)
  zu: {} as any,
  af: {} as any,
  fr: {} as any,
  pt: {} as any,
...
export type I18nDict = typeof translations.en;

// Fill missing languages with EN at runtime (safe)
(translations as any).zu = translations.en;
(translations as any).af = translations.en;
(translations as any).fr = translations.en;
